...
export const FOODS_URL = `${BASE_URL}/products`
export const FOODS_BY_ID_URL = `${BASE_URL}/products`
export const FOODS_BY_NAME_URL = `${BASE_URL}/products/filter`
export const FOODS_BY_TAG_URL = `${BASE_URL}/products/filter`
