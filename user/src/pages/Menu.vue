                    ...
                    <div v-for="(f, index) in currentPageItems" :key="index">
                        <div class="box">
                            ...
                            <div class="image">
                                <img
                                    :src="
                                        require(`../assets/images/${f.food_src}`)
                                    "
                                    alt=""
                                />
                            </div>
                            <div class="content">
                                ...
                                <button class="btn" @click="addItem(index)">
                                    Add to cart
                                </button>
                            </div>
                        </div>
        ...
        filterFoods: function () {
            return this.allFoods.filter(
                (f) =>
                    f.food_name
                        .toLowerCase()
                        .match(this.foodObj.name.toLowerCase()) &&
                    ...
                    f.food_type
                        .toLowerCase()
                        .match(this.foodObj.type.toLowerCase()) &&
